...
# Loading Encoder # 
###################
checkpoint = torch.load("/vol/bitbucket/ja819/Python Files/Latent-GAN/Main Files/Saved models/vFinalAEFinal")
...
for epoch in range(num_epochs_GAN):
    ...
    for i in val_ints:
        ...
        val_velocity_incr = get_velocity_field(i+1)
    ...
    if epoch % 200 == 0:
        ...
        torch.save({
                    ...
                    "/vol/bitbucket/ja819/Python Files/Latent-GAN/Main Files/Saved models/vGANFinal_" + str(epoch))
        print("Model has saved successfully!")

        # Save graph outputs
        newfilePath = '/vol/bitbucket/ja819/Python Files/Latent-GAN/Main Files/GANgraphs/vGANFinal_' + str(epoch) + '.csv'
...
torch.save({
            ...
            'optimizerG_state_dict': optimizerG.state_dict(),
            'optimizerD_state_dict': optimizerD.state_dict() },
            "/vol/bitbucket/ja819/Python Files/Latent-GAN/Main Files/Saved models/vGANFinal1000")
print("Model has saved successfully!")

# Save graph outputs
newfilePath = '/vol/bitbucket/ja819/Python Files/Latent-GAN/Main Files/GANgraphs/vGANFinal1000.csv'
rows = zip(epoch_list, g_loss_list, d_loss_list, bce_loss_list, mse_loss_list, val_loss_list)
with open(newfilePath, "w") as f:
    writer = csv.writer(f)
    for row in rows:
